#!/bin/bash
# L2-IG2 Monitor - Installateur Linux (openSUSE Leap / Tumbleweed)
# Usage : chmod +x install-linux-opensuse.sh && ./install-linux-opensuse.sh
...
echo "======================================================"
echo "  L2-IG2 Monitor - Installateur openSUSE"
echo "======================================================"
echo ""

# Vérification Python 3
if ! command -v python3 &> /dev/null; then
    echo "► Python 3 non détecté, installation via zypper..."
...
pip3 install psutil --quiet 2>&1 || \
    ...
    sudo zypper install -y python3-psutil 2>&1
if ! python3 -c "import psutil" &>/dev/null; then
    echo "❌ Impossible d'installer psutil."
    echo "   Essayez : sudo zypper install python3-psutil"
    exit 1
fi
